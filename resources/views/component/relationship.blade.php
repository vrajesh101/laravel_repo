...
<div class="mt-5">
    ...
    <button class="btn bg-success mr-5" id="m-o">Many to One</button>
    <button class="btn  bg-info mr-5" id="m-m">Many to Many</button>
</div>
...
<script>
    ...
    $(document).on("click", "#o-m", function() {
       ...
       $(document).on("click", "#m-m", function() {
        const baseUrl = window.location.origin;

        $.ajax({
            type: "GET",
            url: `${baseUrl}/many-to-many?usertype=admin`,
      ...
      $(document).on("click", "#m-o", function() {
        const baseUrl = window.location.origin;

        $.ajax({
            type: "GET",
            url: `${baseUrl}/many-to-one?usertype=admin`,
